...
import { confDataType, settingType, settingUiType } from "../../types";
...
it('IS_CONFIG_ERROR', () => {
    const action = { type: 'IS_CONFIG_ERROR', payload: false } as const
...
it('IS_SETTING_CONFIG', () => {
    const action = { type: 'IS_SETTING_CONFIG', payload: false } as const
...
it('SHOW_LOADER', () => {
    const action = { type: 'SHOW_LOADER', payload: true } as const
...
it('SET_CONF_DATA', () => {
    const action = { type: 'SET_CONF_DATA', payload: conf } as const
...
it('SETINGS_LOADDING', () => {
    const action = { type: 'SETINGS_LOADDING', payload: true } as const
...
it('SET_CHENGE_PAGE_STATE', () => {
    const action = { type: 'SET_CHENGE_PAGE_STATE', payload: true } as const
...
it('IS_SETTINGS_SEND', () => {
    const action = { type: 'IS_SETTINGS_SEND', payload: true } as const
